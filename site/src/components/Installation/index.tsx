...
export const Installation = () => {
  ...
  const onCopy = React.useCallback(() => {
    copy('curl -fsSL https://github.com/Gazi2050/gli/releases/latest/download/gli_v0.0.7_linux_amd64.tar.gz | tar xz && sudo mv gli /usr/local/bin/gli && sudo chmod +x /usr/local/bin/gli');
    setCopying((c) => c + 1);
    setTimeout(() => {
      setCopying((c) => c - 1);
    }, 2000);
  ...
  return (
    <div>
      ...
      <code className={styles.code} onClick={onCopy}>
        Download from{' '}
        <a href="https://github.com/Gazi2050/gli/releases" target="_blank" style={{ color: 'inherit', textDecoration: 'underline' }}>
          GitHub Releases
        </a>{' '}
